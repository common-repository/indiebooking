	...
	<div class="panel-body">
        ...
        <table id="full_price_table">
        		...
        		<tr>
        			...
        			<td class="myTableRow appartment_price_table_definition">
        				<?php echo number_format($buchungObj->getFullBrutto(), 2, ',', '.').$waehrung; ?>
    				</td>
        		</tr>
        	 <?php
        	         ...
        	         if ($aktionToCalc->getExpelPriceKz() == "on") {
        	             ...
        	             ?>
                          <tr>
                              ...
                              <td class="myTableRow appartment_price_table_definition">-
                              	<?php echo number_format($aktionToCalc->getPreis(), 2, ',', '.').$typeSign; ?>
                          	</td>
                          </tr>
                          <?php
        	         }
             ...
             <tr>
                 ...
                 <td class="myTableRow appartment_price_table_definition">-
                 	<?php echo number_format($coupon->getValue(), 2, ',', '.').$typeSign; ?>
             	</td>
             </tr>
             <?php }
        	 } ?>
             ...
             <tr>
                 ...
                 <td class="myTableRow appartment_price_table_definition">
                 	<?php echo number_format($taxValue["brutto"], 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
             <?php } ?>
             <tr>
                 ...
                 <td class="myTableRow appartment_price_table_definition">
                 	<?php echo number_format($buchungObj->getCalculatedNetto(), 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
             <?php foreach ($buchungObj->getAllTaxes() as $taxKey => $taxValue) { ?>
             <tr>
                 ...
                 <td class="myTableRow appartment_price_table_definition">
                 	<?php echo number_format($taxValue["taxValue"], 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
             <?php } ?>
             <tr>
                 ...
                 <td class="myTableRow appartment_price_table_definition">
                 	<?php echo number_format($buchungObj->getCalculatedBrutto(), 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
        	 <?php foreach ($buchungObj->getCoupons() as $couponKey => $coupon) {
             ...
             <tr>
                 <td class="myTableRow">- <?php echo $coupon->getCode(); ?></td>
                 <td class="myTableRow appartment_price_table_definition">-
                 	<?php echo number_format($coupon->getValue(), 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
             <?php }
        	 } ?>
        	 <tr>
                 ...
                 <td class="myTableRowBold appartment_price_table_definition">
                 	<?php echo number_format($buchungObj->getCalculatedEndBrutto(), 2, ',', '.').$waehrung; ?>
             	</td>
             </tr>
             </tbody>
        </table>
		...
		<div class="form-group">
    		...
    		<div class="col-xs-10">
                <div id="coupon_input_group" class="input-group">
    				<input class="form-control" type="text" id="apartment_coupon_code" value=""
    						placeholder="<?php esc_attr_e("Coupon Code", 'indiebooking'); ?>"/>
                  	<span class="input-group-addon" id="btn_coupon_span">
                  		<a id="btnApplyCouponCode" class="btn btn-primary btn-lg">
                  			<?php _e("apply", 'indiebooking')?>
              			</a>
          			</span>
                </div>
            </div>
