        ...
        foreach ($buchungKopf->getTeilkoepfe() as $teilKopf) {
            ...
            ?>
			            <tr>
			            	...
			            	&nbsp;-&nbsp;<?php echo $teilKopf->getAppartment_name(); ?>
			            	</th>
			            </tr>
            <?php
	                } else {
	                	?>
	                	<tr>
	                		<th colspan="8"><?php echo $teilKopf->getAppartment_name(); ?></th>
		            	</tr>
		            	<?php
	                }
               	}
               	...
               	<tr>
    				...
    				<th style="text-align: left;" colspan="2"><?php echo $stornoZahlung->getBezeichnung();?></th>
                   	<th class="<?php echo $tdClass; ?>" <?php echo $tdNumberStyle; ?>>
                   		<?php echo number_format($stornoZahlung->getZahlungbetrag(), 2, ',', '.');?>
                   	</th>
<!--                    	<td> &nbsp;</td> -->
               	</tr>
       	   <?php
            ...
            <tr>
                <th colspan="3">&nbsp;</th>
                <th style="text-align: left;" colspan="2"><?php _e("missing amount", 'indiebooking'); ?></th>
                <th class="<?php echo $tdClass; ?>" <?php echo $tdNumberStyle; ?>>
...
?>
<?php
if ($buchungKopf->getHauptZahlungsart() == "INVOICE" && (!$bookingIsInquiry)) {
